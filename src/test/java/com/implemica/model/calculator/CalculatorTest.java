...
public class CalculatorTest {
   ...
   void boundaryTest() throws OverflowException, UndefinedResultException, InvalidInputException {
      ...
      String theMaxNumber = oneSubtractTheSmallestNumber + maxMinusOne + "+ MR = MC M+ C " + smallNumber + " + MR =";

      String theMinNumber = oneSubtractTheSmallestNumber + negateMaxSubtractMin + " - MR = MC M+ C " + smallNumber + "×1n + MR =";

      // right side
      // expected number : 999999999999999999999999(9).999999999...99
      // where the integer part have digit 9 1000 times and imaginary part of the number have digit 9 20000 times.
